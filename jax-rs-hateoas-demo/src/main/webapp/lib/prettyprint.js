        ...
        row: function(cells, type, cellType) {
            ...
            util.forEach(cells, function(cell){
                ...
                if (cell.nodeType) {
                    ...
                    /* IsString */
                    /*
                    alert(util.shorten(cell.toString()));
                    //var ip = document.createElement("<INPUT TYPE='text' NAME='a' VALUE='"+cell.toString()+"'>");
                    var ip = document.createElement("input");
                    ip.type = 'text';
                    ip.value = cell.toString();
                    td.appendChild(ip);
                    */
    ...
    var prettyPrintThis = function(obj, options) {
        ...
        var typeDealer = {
            string : function(item){
                ...
                //return util.txt('<input type="text" value="' + util.shorten(item.replace(/"/g,'\\"')) + '" />');
                //return document.createElement('<INPUT TYPE="TEXT" NAME="" VALUE="'+item.replace(/"/g,'\\"')+'">');
            },
